...
class Platform(LatticePlatform):
    def __init__(self, revision=None, device="25F", toolchain="trellis"):
        ...
        self.spi_size = int(16*1024*1024)
        self.spi_dummy = 6
    ...
    f"""Foboot build complete.  Output files:
        {output_dir}/gateware/orangecart.bit      Basic Bitstream file.  Load this onto the FPGA for testing.
        ...
        {output_dir}/gateware/orangecart.svf      Serial Vector Format File. Useful when loading over JTAG.
        {output_dir}/gateware/orangecart.v        Source Verilog file.  Useful for debugging issues.
